...
MatchData R1M1 = new 
//MatchData East
MatchData ER1M1 = new MatchData(UConnFirst, StetsonFirst);
...
MatchData ER1M5 = new MatchData(BYUFirst, DuquensneFirst);
MatchData ER2M3 = new MatchData(DuquesneSecond, ILSecond);
MatchData ER1M6 = new MatchData(ILFirst, MoreheadFirst);
MatchData ER1M7 = new MatchData(WashStateFirst, DrakeFirst);
MatchData ER2M4 = new MatchData(WashStateSecond, IASecond);
MatchData ER1M8 = new MatchData(IowaFirst, SouthDakotaFirst);
MatchData ER16M1 = new MatchData(ILSixteen, IASixteen);
